...
<figure markdown>
  ![DOI import option](../assets/screenshots/doi-option.png)
...
<figure markdown>
  ![DOI input field](../assets/screenshots/doi-input.png)
...
<figure markdown>
  ![Preview of publications to import](../assets/screenshots/DOI-preview.png)
...
<figure markdown>
  ![Importing publications one by one](../assets/screenshots/DOI-onebyone.png)
...
<figure markdown>
  ![Validating the entry](../assets/screenshots/doi-preview.png)
...
<figure markdown>
  ![Finish import](../assets/screenshots/DOI-end-import.png)
