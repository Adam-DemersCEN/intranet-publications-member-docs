...
Le module de publications vous permet d'ajouter rapidement une ou plusieurs publications en entrant son DOI (Digital Object Identifier) ou son WoS ID (Web of Science Identifier). Les métadonnées sont récupérées automatiquement depuis les bases de données bibliographiques.

## Accéder à l'import par DOI

Depuis la page d'accueil du module, repérez le menu **Importer**, puis sélectionnez l'option **DOI**.

<figure markdown>
  ![Option d'import par DOI](../assets/screenshots/doi-option.png)
  <figcaption>Sélectionnez "DOI"</figcaption>
</figure>

## Entrer le(s) DOI(s)

Saisissez le DOI ou le WoS ID de la publication dans le champ prévu à cet effet, puis cliquez sur **Rechercher et importer**. Pour importer plusieurs publications, entrez les différents identifiants un par ligne.
...
<figure markdown>
  ![Champ de saisie du DOI](../assets/screenshots/doi-input.png)
  <figcaption>Entrez le DOI ou le WoS ID de la publication</figcaption>
</figure>
...
**Prochaine étape :** [Rechercher des publications →](search.md)
